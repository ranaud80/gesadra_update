...
class FormDM:
    ...
    def txtFileDM(self):
        ...
        fic.write("Zone Défense : " + Commun.encode(self.cbZoneDef.get())+"\n")
        fic.write("Département  : " + Commun.encode(self.eDept.get())+"\n")
        fic.write("--------------------------------------------------------------------------------\n")

        # Demande de personnel(s) 
        fic.write("Demande de Personnels\n")
        fic.write("Séc. Civile  : " + Commun.encode(self.ePersSC.get())+"\n")
        fic.write("Militaires   : " + Commun.encode(self.ePersMil.get())+"\n")
        fic.write("Autre        : " + Commun.encode(self.ePersAutre.get())+"\n")
        fic.write("--------------------------------------------------------------------------------\n")

        # Demande de moyen(s)
        fic.write("Moyen(s) Aérien(s)\n")
        fic.write("Hélicoptère  : " + Commun.encode(self.eHelico.get())+"\n")
        fic.write("Avion        : " + Commun.encode(self.eAvion.get())+"\n")

        fic.write("Moyen(s) Terrestre(s)\n")
        fic.write("Engin(s) TP  : " + Commun.encode(self.eEnginTP.get())+"\n")
        fic.write("Grue(s)      : " + Commun.encode(self.eGrue.get())+"\n")

        fic.write("Autre(s)-1   : " + Commun.encode(self.eAutre1.get())+"\n")
        fic.write("Autre(s)-2   : " + Commun.encode(self.eAutre2.get())+"\n")
        fic.write("--------------------------------------------------------------------------------\n")
        
        # Demande de matériel(s)
        fic.write("Groupe(s) électrogène(s) \n")
        fic.write("> 20 KVa     : " + Commun.encode(self.eSup20.get())+"\n")
        fic.write("> 100 KVa    : " + Commun.encode(self.eSup100.get())+"\n")
        fic.write("< 100 KVa    : " + Commun.encode(self.eInf100.get())+"\n")

        fic.write("Moto(s) pompe(s) \n")
        fic.write("> 160 M3/H   : " + Commun.encode(self.eSup160.get())+"\n")
        fic.write("= 160 M3/H   : " + Commun.encode(self.eEgal160.get())+"\n")
        fic.write("< 160 M3/H   : " + Commun.encode(self.eInf160.get())+"\n")

        fic.write("Traitement de l'eau \n")
        fic.write("Station EP   : " + Commun.encode(self.eStaEP.get())+"\n")
        fic.write("Station EU   : " + Commun.encode(self.eStaEU.get())+"\n")
        fic.write("--------------------------------------------------------------------------------\n")

        fic.write("Demande de matériel(s) Divers\n")
        fic.write("Scie(s)      : " + Commun.encode(self.eScie.get())+"\n")
        fic.write("Pelle(s)     : " + Commun.encode(self.ePelle.get())+"\n")
        fic.write("CMIR - CMIC  : " + Commun.encode(self.eCMIR.get())+"\n")
        fic.write("PMA          : " + Commun.encode(self.ePMA.get())+"\n")
        fic.write("Autre(s)-1   : " + Commun.encode(self.eMatAutre1.get())+"\n")
        fic.write("Autre(s)-2   : " + Commun.encode(self.eMatAutre2.get())+"\n")
        fic.write("\n")
        fic.write('--------------------------------------------------------------------------------\n')
    ...
    def xmlFileDM(self):
        ...
        fic.write("<zdef>" + Commun.encode(self.cbZoneDef.get())+"</zdef>\n")
        fic.write("<dpt>" + Commun.encode(self.eDept.get())+"</dpt>\n")
        fic.write("<ong1>\n")
        fic.write("<secciv>" + Commun.encode(self.ePersSC.get())+"</secciv>\n")
        fic.write("<mili>" + Commun.encode(self.ePersMil.get())+"</mili>\n")
        fic.write("<autre>" + Commun.encode(self.ePersAutre.get())+"</autre>\n")
        fic.write("</ong1>\n")
        fic.write("<ong2>\n")
        fic.write("<helico>" + Commun.encode(self.eHelico.get())+"</helico>\n")
        fic.write("<avion>" + Commun.encode(self.eAvion.get())+"</avion>\n")
        fic.write("<engin>" + Commun.encode(self.eEnginTP.get())+"</engin>\n")
        fic.write("<grue>" + Commun.encode(self.eGrue.get())+"</grue>\n")
        fic.write("<aut-1>" + Commun.encode(self.eAutre1.get())+"</aut-1>\n")
        fic.write("<aut-2>" + Commun.encode(self.eAutre2.get())+"</aut-2>\n")
        fic.write("</ong2>\n")
        fic.write("<ong3>\n")
        fic.write("<sup20>" + Commun.encode(self.eSup20.get())+"</sup20>\n")
        fic.write("<sup100>" + Commun.encode(self.eSup100.get())+"</sup100>\n")
        fic.write("<inf100>" + Commun.encode(self.eInf100.get())+"</inf100>\n")
        fic.write("<sup160>" + Commun.encode(self.eSup160.get())+"</sup160>\n")
        fic.write("<egal160>" + Commun.encode(self.eEgal160.get())+"</egal160>\n")
        fic.write("<inf160>" + Commun.encode(self.eInf160.get())+"</inf160>\n")
        fic.write("<staep>" + Commun.encode(self.eStaEP.get())+"</staep>\n")
        fic.write("<staeu>" + Commun.encode(self.eStaEU.get())+"</staeu>\n")
        fic.write("</ong3>\n")
        fic.write("<ong4>\n")
        fic.write("<scie>" + Commun.encode(self.eScie.get())+"</scie>\n")
        fic.write("<pelle>" + Commun.encode(self.ePelle.get())+"</pelle>\n")
        fic.write("<cmic>" + Commun.encode(self.eCMIR.get())+"</cmic>\n")
        fic.write("<pma>" + Commun.encode(self.ePMA.get())+"</pma>\n")
        fic.write("<aut-1>" + Commun.encode(self.eMatAutre1.get())+"</aut-1>\n")
        fic.write("<aut-2>" + Commun.encode(self.eMatAutre2.get())+"</aut-2>\n")
        fic.write("</ong4>\n")
        fic.write('</corps>\n')
        fic.write('<bot>\n')
