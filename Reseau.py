...
#
    ...
    def drawReseau(self):
        ...
        self.lbListe = Listbox(fLog, height = 16, width = 140, font = self.root.fonteFixe, yscrollcommand = sbListe.set)
...
#
    ...
    def initChamps(self):
        ...
        for i in range (1,29):  #passage à 29 stations
...
#
    ...
    def ajouterStation(self, event=None):
        ...
        if int(self.num.get()) > 29:
            tkMessageBox.showinfo('Gestion du Réseau', 'Liste limitée à 29 indicatifs')
            return
...
# 
    ...
    def imprimer(self):
        ...
        # Corps du message
        for i in range(1,29): #de (1,15) à (1,29)
